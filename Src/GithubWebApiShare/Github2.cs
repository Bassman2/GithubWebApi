...
/// </summary>
public sealed partial class Github2: JsonService
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Github2"/> class using a store key and application name.
    /// </summary>
    ...
    public Github2(string storeKey, string appName) : base(storeKey, appName, SourceGenerationContext.Default)
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Github2"/> class using a host URI, an optional authenticator, and an application name.
    /// </summary>
    ...
    /// <param name="appName">The name of the application using the GitHub API.</param>
    public Github2(Uri host, IAuthenticator? authenticator, string appName) : base(host, authenticator, appName, SourceGenerationContext.Default)
    {
        client!.DefaultRequestHeaders.Add("Accept", "application/vnd.github+json");
        client!.DefaultRequestHeaders.Add("X-GitHub-Api-Version", "2022-11-28");
        client!.DefaultRequestHeaders.Add("User-Agent", appName);
